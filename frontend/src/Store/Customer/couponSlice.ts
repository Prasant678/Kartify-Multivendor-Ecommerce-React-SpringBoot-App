...
export const applyCoupon = createAsyncThunk<Cart, { apply: string; code: string; orderValue: number; jwt: string; }, { rejectValue : string} >("/coupon/applyCoupon", async ({ apply, code, orderValue, jwt }, { rejectWithValue }) => {
    try {
