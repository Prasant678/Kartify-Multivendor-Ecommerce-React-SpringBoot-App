...
const AccountStatus = [
  { status: 'PENDING VERIFICATION', title: 'Pending Verification' },
            ...
            {rows.map((row) => (
              <StyledTableRow key={row.name}>
                ...
                <StyledTableCell align="right">
                  <Button size="small" variant="contained" color="secondary"><p>Change Status</p></Button>
                </StyledTableCell>
              </StyledTableRow>
            ))}
          </TableBody>
