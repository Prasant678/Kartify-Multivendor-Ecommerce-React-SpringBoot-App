...
public class AuthServiceImpl implements AuthService {
    ...
    public void sentLoginOtp(String email, USER_ROLE role) throws Exception {
        ...
        if (email.startsWith(SIGNING_PREFIX)) {
            ...
            if (role == USER_ROLE.ROLE_SELLER){
                ...
                if (user == null) {
                    throw new Exception("User Dose not Exist with Provided Email");
                }
            }
        }
    ...
    public String createUser(SignupRequest req) throws Exception {
        ...
        if (user == null) {
            ...
            createdUser.setMobileNo("8582452365");
    ...
    private Authentication authenticate(String username, String otp) throws BadCredentialsException {
